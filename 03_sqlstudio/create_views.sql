CREATE OR REPLACE VIEW kura.flights
-- CREATE MATERIALIZED VIEW kura.flights
...
CREATE OR REPLACE VIEW kura.delayed_10 AS
SELECT * FROM kura.flights WHERE dep_delay >= 10;

CREATE OR REPLACE VIEW kura.delayed_15 AS
SELECT * FROM kura.flights WHERE dep_delay >= 15;

CREATE OR REPLACE VIEW kura.delayed_20 AS
SELECT * FROM kura.flights WHERE dep_delay >= 20;
