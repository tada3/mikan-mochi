...
def ingest(year, month, bucket, ds):
    '''
   ...
   '''
    ...
    try:
        ...
        return bqload(gcsloc, year, month, ds)
    finally:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', help='BigQuery dataset to upload data to')
    ...
    try:
        ...
        tableref, numrows = ingest(year_, month_, args.bucket, ds_)
